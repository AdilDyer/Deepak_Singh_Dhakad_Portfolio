...
export const PillDoodle = ({ className }: { className?: string }) => (
  <svg className={`${styles.doodle} ${className}`} width="50" height="50" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const DocumentDoodle = ({ className }: { className?: string }) => (
  <svg className={`${styles.doodle} ${className}`} width="50" height="50" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const FlaskDoodle = ({ className }: { className?: string }) => (
  <svg className={`${styles.doodle} ${className}`} width="50" height="50" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const DNAHelixDoodle = ({ className }: { className?: string }) => (
  <svg className={`${styles.doodle} ${className}`} width="50" height="50" viewBox="0 0 50 50" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
